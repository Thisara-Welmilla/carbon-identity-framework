...
public class APIClientTest {
     ...
     */
    @Test
    public void testCallAPIWithUnsupportedHttpMethod() throws APIClientRequestException {

        // Create request context with an unsupported method
        // The current implementation only supports POST, so any other method should throw exception
        // For now, let's test that POST works, and in a real scenario where GET is added but not supported,
        // this test would be updated accordingly

        // This test verifies the switch case default behavior
        // We can't test this directly with current HttpMethod enum as it only has POST
        // But the test structure is here for when more methods are added
        assertTrue(true); // Placeholder for unsupported method test
    }
    ...
    public void testCallAPIWithBasicAuthentication() throws Exception {
        ...
        APIRequestContext basicAuthContext = new APIRequestContext.Builder()
                .setHttpMethod(APIRequestContext.HttpMethod.POST)
                .setApiAuthentication(basicAuth)
                .setEndpointUrl(ENDPOINT_URL)
    ...
    public void testCallAPIWithBearerAuthentication() throws Exception {
        ...
        APIRequestContext bearerAuthContext = new APIRequestContext.Builder()
                .setHttpMethod(APIRequestContext.HttpMethod.POST)
                .setApiAuthentication(bearerAuth)
                .setEndpointUrl(ENDPOINT_URL)
                .setHeaders(new HashMap<>())
                .setPayload(PAYLOAD)
                .build();
    ...
    public void testCallAPIWithApiKeyAuthentication() throws Exception {
        ...
        APIRequestContext apiKeyAuthContext = new APIRequestContext.Builder()
                .setHttpMethod(APIRequestContext.HttpMethod.POST)
                .setApiAuthentication(apiKeyAuth)
                .setEndpointUrl(ENDPOINT_URL)
                .setHeaders(new HashMap<>())
                .setPayload(PAYLOAD)
                .build();
    ...
    public void testCallAPIWithCustomHeaders() throws Exception {
        ...
        APIRequestContext customHeadersContext = new APIRequestContext.Builder()
                .setHttpMethod(APIRequestContext.HttpMethod.POST)
                .setApiAuthentication(requestContext.getApiAuthentication())
                .setEndpointUrl(ENDPOINT_URL)
    ...
    public void testCallAPIWithLargePayload() throws Exception {
        ...
        APIRequestContext largePayloadContext = new APIRequestContext.Builder()
                ...
                .setEndpointUrl(ENDPOINT_URL)
                .setHeaders(new HashMap<>())
                .setPayload(largePayload.toString())
                .build();
