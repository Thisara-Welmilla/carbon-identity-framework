...
public class APIAuthPropertyTest {
     ...
     */
    @Test
    public void testCreateAPIAuthPropertyWithValidParameters() {
    ...
    public void testCreateAPIAuthPropertyWithEmptyName() {
        ...
        APIAuthProperty authProperty = new APIAuthProperty.Builder(EMPTY_STRING, PROPERTY_VALUE).build();

        assertNotNull(authProperty);
        assertEquals(authProperty.getName(), EMPTY_STRING);
        assertEquals(authProperty.getValue(), PROPERTY_VALUE);
    }
     ...
     */
    @Test
    public void testCreateAPIAuthPropertyWithEmptyValue() {
    ...
    public void testCreateAPIAuthPropertyWithNullName() {
        ...
        APIAuthProperty authProperty = new APIAuthProperty.Builder(NULL_VALUE, PROPERTY_VALUE).build();

        assertNotNull(authProperty);
        assertEquals(authProperty.getName(), NULL_VALUE);
        assertEquals(authProperty.getValue(), PROPERTY_VALUE);
    }
    ...
    public void testCreateAPIAuthPropertyWithNullValue() {
        ...
        APIAuthProperty authProperty = new APIAuthProperty.Builder(PROPERTY_NAME, NULL_VALUE).build();

        assertNotNull(authProperty);
        assertEquals(authProperty.getName(), PROPERTY_NAME);
        assertEquals(authProperty.getValue(), NULL_VALUE);
    }
    ...
    public void testCreateAPIAuthPropertyWithBothNullNameAndValue() {
        ...
        APIAuthProperty authProperty = new APIAuthProperty.Builder(NULL_VALUE, NULL_VALUE).build();
