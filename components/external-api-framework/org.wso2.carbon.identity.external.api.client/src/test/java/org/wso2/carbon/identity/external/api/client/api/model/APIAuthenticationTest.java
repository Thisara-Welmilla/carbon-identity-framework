...
public class APIAuthenticationTest {
    ...
    public void testCreateAuthenticationWithNullAuthType() {
        ...
        try {
            ...
            assertTrue(e.getMessage().contains("Authentication authType must be provided"));
        }
    }
    ...
    public void testCreateBasicAuthenticationWithMissingUsername() {
        ...
        try {
            ...
            assertTrue(e.getMessage().contains("must be provided as an authentication property"));
        }
    }
    ...
    public void testCreateBasicAuthenticationWithBlankUsername() {
        ...
        try {
            ...
            assertTrue(e.getMessage().contains("cannot be blank"));
        }
    }
