...
public class APIResponseTest {
    ...
    public void testBuilderReturnsCorrectInstance() {
        ...
        APIResponse.Builder returnedBuilder = builder.setStatusCode(STATUS_CODE_404);
        assertEquals(builder, returnedBuilder);

        returnedBuilder = builder.setResponseBody("New Response");
        assertEquals(builder, returnedBuilder);
    }
