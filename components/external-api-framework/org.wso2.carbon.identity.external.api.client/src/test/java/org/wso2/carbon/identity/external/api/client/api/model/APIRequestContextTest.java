...
public class APIRequestContextTest {
     ...
     */
    @Test
    public void testCreateAPIRequestContextWithMinimalParameters() {
    ...
    public void testCreateAPIRequestContextWithNullHttpMethod() {
        ...
        try {
            ...
            assertTrue(e.getMessage().contains("HTTP method must be provided"));
        }
    }
    ...
    public void testCreateAPIRequestContextWithNullAuthentication() {
        ...
        try {
            ...
            assertTrue(e.getMessage().contains("API authentication must be provided"));
        }
    }
    ...
    public void testCreateAPIRequestContextWithNullEndpointUrl() {
        ...
        try {
            ...
            assertTrue(e.getMessage().contains("Endpoint URL must be provided"));
        }
    }
    ...
    public void testCreateAPIRequestContextWithNullPayload() {
        ...
        try {
            ...
            assertTrue(e.getMessage().contains("Payload must be provided"));
        }
    }
     ...
     */
    @Test
    public void testCreateAPIRequestContextWithEmptyHeaders() {
     ...
     */
    @Test
    public void testCreateAPIRequestContextWithMultipleHeaders() {
    ...
    public void testBuilderReturnsCorrectInstance() {
        ...
        APIRequestContext.Builder returnedBuilder = builder.setHttpMethod(APIRequestContext.HttpMethod.POST);
        assertEquals(builder, returnedBuilder);

        returnedBuilder = builder.setApiAuthentication(apiAuthentication);
        assertEquals(builder, returnedBuilder);

        returnedBuilder = builder.setEndpointUrl(ENDPOINT_URL);
        assertEquals(builder, returnedBuilder);

        returnedBuilder = builder.setHeaders(headers);
        assertEquals(builder, returnedBuilder);

        returnedBuilder = builder.setPayload(PAYLOAD);
        assertEquals(builder, returnedBuilder);
    }
}
